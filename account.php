<?php
    session_start();
    $user = ($_SESSION['user']);
    include('database/upload-acc.php');
...
<!-- <div class="search-wrapper">
        ...
        //  -->
            ...
            <input type="file" name="file" accept=".xlsx, .xlsm, .xlsb, .xltx, .xltm, .xls, .xlt, .xls, .xlw, .xlr " value="Upload">
                ...
                <table class="this-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="database/download-acc.php?file=<?php echo $rows ['name']?>">Download <i class="fa fa-download"></i></a>
                            
                        </td>
                        <td>
                            <a href="database/preview-acc.php?file=<?php echo $rows ['name']?>" target="_blank"><i class="fa fa-eye"></i> Preview</a>
                        </td>
                        <td>
